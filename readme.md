...
Learn the basics of Continuous Integration and Continuous Delivery and implement them using Jenkins and Azure DevOps. You will learn to Create Kubernetes Clusters and Deploy Microservices to Kubernetes using Azure DevOps Pipelines on the Cloud with AWS EKS and Azure AKS.
...
Perfect first step as an introduction to DevOps.


## learned
- DevOps with Docker, Kubernetes and Azure DevOps from ZERO, no previous experience required
- the fundamentals of 6 Most Popular DevOps Tools - Docker, Kubernetes, Azure Devops, Jenkins, Terraform, and Ansible
- the building blocks of DevOps - Continuous Integration, Continuous Delivery and Infrastructure as Code
- to implement Azure Devops Pipelines integrating Docker, Kubernetes and  Terraform on AWS EKS and Azure AKS
- DevOps with Continuous Integration & Continuous Delivery on Azure DevOps and Jenkins
- do containerization and container orchestration for microservices with Docker and Kubernetes
- play with Docker, Docker Compose and Kubernetes
